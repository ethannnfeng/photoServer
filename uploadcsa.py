...
blob_service_client = BlobServiceClient.from_connection_string(conn_str="DefaultEndpointsProtocol=https;AccountName=photouploadcsa;AccountKey=Q948uHXd+ymt0BAlKz7XFoA8sY4e07Q2Z2OWlHhDgJF9jHwCmv4+Y4JbunvCAyLmAi/5iqtVmtsA+AStrcvKtw==;EndpointSuffix=core.windows.net") # create a blob service client to interact with the storage account
try:
